...
<div class="row">
 ...
 <div style="width:960px;height:350px;">
                    ...
                    <div style="width:635px;height:350px;float:left;padding-top:20px; background-color: rgba(220,220,200,0.6);">
                    

        <center><h2 style="color:white">  Lecture Panel </h2>

    <?php

    include("config.php");

    $qq = "select * from lecture ";
