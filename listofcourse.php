...
<body  style="background-image: url(sharon-mccutcheon-528615-unsplash.jpg);background-size: cover; color: black;">
    ...
    <div class="col-lg-8" style="margin-top: 150px;text-align: center;background-color:rgb(200,200,0,0.6)">
<form action="" method="POST" >
<br><h3 style="background-color: rgba(200,100,100,0.3);" >List Of Course</h3><br>
<table class="table table-striped table-responsive">
    <tr><th>Course ID</th><th>Course Name</th><th>Course Duration</th><th>Action</th></tr>
         ...
         while($row = mysql_fetch_array($r))
            {
                ...
                ?>
        <tr><td><?php echo "$cid"; ?></td><td><?php echo "$cname"; ?></td><td><?php echo "$duration"; ?></td><td>
    <button name="t1" class="btn btn-success" value='<?php echo($cid)?>'>Delete</button></td></tr>
