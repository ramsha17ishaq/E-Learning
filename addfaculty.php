...
<body  style="background-image: url(sharon-mccutcheon-528615-unsplash.jpg);background-size: cover; color: black;">
 ...
 <div class="row">
    ...
    <div class="col-lg-2" style="margin-top: 150px;text-align: center;"></div>
    <div class="col-lg-8" style="margin-top: 150px;text-align: center;background-color:rgb(250,200,100,0.3)">
<form action="" method="post" style="">


<div class="col-lg-3">   </div>
<div class="col-lg-6">   
<br><h3 style="background-color: rgba(100,100,100,0.3);" >Add Faculty</h3><br>
<h3 >Enter First Name</h3>
    <input type="text" name="t1"  pattern="[a-zA-Z\s]+" required="" class="form-control">
    <h3 >Enter Last Name</h3>
    <input type="text" name="t2"  pattern="[a-zA-Z\s]+" required="" class="form-control">
<h3 >Gender</h3>
    <input type="radio" name="t3"  required="" value="male">: Male 
   
    <input type="radio" name="t3" required="" value="female">: Female
    <h3 >Select Course </h3>
    <select  name="t4" required="" class="form-control">
        <option value="java">Java</option>
          <option value="php">Php</option>
            <option value="python">Pyhton</option>
    </select>
    <h3 >Enter Mobile No.</h3>
    <input type="text" name="t5"   pattern=".{10,10}" maxlength="10" minlength="10" pattern="/d*" title="password maxlength is 10 and minlength is also 10 digits" required="" class="form-control">
       <br><br>
...
<?php
    ...
    if($r > 0)
    {
        echo "<script>alert('Faculty Successfully Added');</script>";
         ...
         echo "<script>alert('Faculty Cannot Added');</script>";
